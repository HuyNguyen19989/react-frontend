            ...
            <Row className='footer-1'>
              <Col sm='4' className='fooer-block'>
                ...
                <div>
                  ...
                  Truyencv là website đọc truyện convert online cập nhật liên tục và nhanh nhất các truyện tiên hiệp, 
                  kiếm hiệp, huyền ảo được các thành viên liên tục đóng góp rất nhiều truyện hay và nổi bật: The 99th Divorce
                  </p>
                </div>
              </Col>
              <Col sm='4' className='fooer-block'>
